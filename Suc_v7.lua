...
Create("TextLabel", {Size = UDim2.new(1, -110, 1, 0), Position = UDim2.new(0, 10, 0, 0), BackgroundTransparency = 1, Text = "SUC_CORE :: V8.7 2ND CHANCE", TextColor3 = Color3.fromRGB(0, 170, 255), Font = Enum.Font.GothamBlack, TextSize = 11, TextXAlignment = Enum.TextXAlignment.Left, ZIndex = 1}, Header)
...
BtnBlack.TextColor3 = isBlack and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(180, 180, 180)
...
t_spawn(function()
    pcall(function()
        ...
        Log("V8.7 Loaded. 2-Strike Hop Rule.", Color3.fromRGB(0, 170, 255))
    end)
end)
local Blacklist = {}
local SZTimer = {}
...
t_spawn(function()
    while t_wait(0.1) do
        pcall(function()
            ...
            if curTool then
                T_Wep.Text = "WEAPON: " .. string.upper(curTool.Name)
            else
                T_Wep.Text = "WEAPON: NONE"
            end
        end)
    end
end)
